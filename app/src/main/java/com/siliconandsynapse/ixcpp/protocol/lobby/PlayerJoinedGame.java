...
//
//	public PlayerJoinedGame(IxAddress baseAddr, IGameGrid roomModel)
//	{
//		super();
//
...
//
//		try {
//			game = path.evaluate("/PlayerJoinedGame/@gameID", doc);
//			playerName = path.evaluate("/PlayerJoinedGame/@playerID", doc);
//		} catch (XPathExpressionException e) {
//			e.printStackTrace();
//			return;
//		}
//
//		roomModel.addPlayerToGame(game, playerName);
//
//	}
